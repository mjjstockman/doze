  ...
  return (
    <header className="sticky top-0 z-10">
      <nav className="flex items-center px-6 md:px-16 py-6 justify-between bg-center bg-white border-b border-gray-200">
        ...
        {/* Desktop Navigation */}
        {isUserLoggedIn ? (
        <div className="hidden sm:flex space-x-8 text-lg" aria-label="main">
          <Link
          ...
          <div className=" flex relative" aria-label="main"> 
            ...
            {toggleMobileMenu && (
              <div className="absolute right-0 top-full mt-3 w-full  p-5 rounded-lg bg-white min-w-[210px] flex flex-col gap-2  shadow">
                <div>
                  <span className="block text-sm text-gray-900 dark:text-white p-1">User Name</span>
      ...
      {isUserLoggedIn ? (
        ...
        <div className="sm:hidden flex relative text-lg" aria-label="main">
